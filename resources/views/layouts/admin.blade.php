...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="display:flex" class="font-sans antialiased">
        <div  style="width:20%" class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        ...
        <main style="width:80%"  class="m-2 p-8 w-full">
